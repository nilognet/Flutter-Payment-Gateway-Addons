...
import 'package:paystack_gateway/widgets/paystack_webview_screen.dart';

class PayStackGatewayWeb implements PaymentBase {
  /// Payment method key
  ///
  ...
  Future<void> initialized({
    ...
    try {
      ...
      final result = await Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (context, _, __) => PayStackWebViewScreen(
            data: checkoutData,
