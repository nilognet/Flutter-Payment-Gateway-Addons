library xendit_gateway;

import 'package:flutter/widgets.dart';
import 'package:payment_base/payment_base.dart';
import 'package:xendit_gateway/widgets/xendit_webview_screen.dart';

class XenditGatewayWeb implements PaymentBase {
  /// Payment method key
  ///
  static const key = "xendit_cc";

  @override
  String get libraryName => "xendit_gateway";

  @override
  String get logoPath => "assets/images/xendit_logo.png";
  ...
  Future<void> initialized({
    ...
    try {
      ...
      final result = await Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (context, _, __) => XenditWebViewScreen(
            data: checkoutData,
