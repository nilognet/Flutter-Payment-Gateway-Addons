library midtrans_gateway;

import 'package:flutter/widgets.dart';
import 'package:midtrans_gateway/widgets/midtrans_webview_screen.dart';
import 'package:payment_base/payment_base.dart';

class MidtransGatewayWeb implements PaymentBase {
  /// Payment method key
  ///
  static const key = "midtrans";

  @override
  String get libraryName => "midtrans_gateway";

  @override
  String get logoPath => "assets/images/midtrans_logo.png";
  ...
  Future<void> initialized({
    ...
    try {
      ...
      final result = await Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (context, _, __) => MidtransWebViewScreen(data: checkoutData,
