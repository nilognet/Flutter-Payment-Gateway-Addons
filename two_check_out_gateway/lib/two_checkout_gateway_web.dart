library two_check_out_gateway;

import 'package:flutter/widgets.dart';
import 'package:payment_base/payment_base.dart';
import 'package:two_check_out_gateway/widgets/two_checkout_webview_screen.dart';

class TwoCheckoutGatewayWeb implements PaymentBase {
  /// Payment method key
  ///
  static const key = "twocheckout_convert_plus";

  @override
  String get libraryName => "two_check_out_gateway";

  @override
  String get logoPath => "assets/images/2checkout_logo.png";
  ...
  Future<void> initialized({
    ...
    try {
      ...
      final result = await Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (context, _, __) => TwoCheckoutWebViewScreen(
            data: checkoutData,
